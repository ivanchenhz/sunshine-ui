...
module.exports = {
  ...
  variants: {
    ...
    backgroundColor: ['responsive', 'dark', 'group-hover', 'focus-within', 'hover', 'focus', 'checked', 'important'],
    ...
    borderColor: ['responsive', 'dark', 'group-hover', 'focus-within', 'hover', 'focus', 'checked', 'important'],
